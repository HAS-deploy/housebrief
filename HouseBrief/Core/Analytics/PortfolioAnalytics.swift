...
final class PortfolioAnalytics: @unchecked Sendable {
    ...
    func start(appName: String) {
        ...
        // Portfolio rule (`feedback_portfolio_analytics_must_fix.md`):
        // register `app` as a super-property so PostHog auto-events
        // (Application Installed, Opened, etc.) carry the app tag.
